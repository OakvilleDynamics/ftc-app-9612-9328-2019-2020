...
@Autonomous(name = "blueBuildPlatev2 (Blocks to Java)", group = "")
public class blueBuildPlatev2 extends LinearOpMode {
   ...
   * Describe this function...
   */
  private void rotateCounterClockwiseSlow() {
    LeftStickX = 0;
    LeftStickY = 0;
    RightStickX = -0.4;
    move();
